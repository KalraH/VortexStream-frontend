...
import { timeAgo } from "../helpers/timeAlgo";
import { toggleSubscription } from "../store/slices/subscription.slice";
...
function Description({
        ...
        const [localIsSubscribed, setLocalIsSubscribed] =
        ...
        return (
                <>
                        {/* Updated: Removed sm:max-w-4xl constraint for full width */}
                        <section className="w-full mx-auto text-white sm:p-5 p-2 space-y-2">
                                                ...
                                                <div className="flex gap-2 justify-between items-center">
                                                        ...
                                                        <div>
                                                                <Button
                                                                        ...
                                                                        className="border-slate-500 hover:scale-110 transition-all text-black font-bold px-4 py-1 bg-lime-500"
                                                                >
                                                                        {localIsSubscribed
                                                                                ? "Subscribed"
                                                                                : "Subscribe"}
