...
import { GetImagePreview, Spinner, Input2, Button } from "./index";
import { updateAVideo, updateUploadState } from "../store/slices/video.slice";
                ...
                <>
                        <div className="fixed mt-5 top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-70 z-50">
                                <form
                                        ...
                                        className=" bg-black space-y-2 border h-[30rem] overflow-y-auto outline-none p-2"
                                >
                                        ...
                                        <div className="p-2 grid lg:grid-cols-2 grid-cols-1 gap-5 z-40">
                                                ...
                                                <div className="flex flex-col justify-between sm:gap-0 gap-2">
                                                        ...
                                                        <div className="mb-4">
                                                                ...
                                                                <textarea
                                                                        rows="4"
                                                                        className="focus:bg-[#222222] text-sm overflow-y-auto bg-transparent outline-none border w-full mt-1 p-1"
                                                                        {...register(
                                                                                "description",
                                                                                {
                                                        ...
                                                        <div className="flex gap-3">
                                                                ...
                                                                <Button
                                                                        className="flex-1 bg-lime-500 p-2 font-bold"
