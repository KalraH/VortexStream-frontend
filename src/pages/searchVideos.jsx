...
function SearchVideos() {
	...
	return (
		<>
			...
			>
				<span className="text-white hover:text-lime-500">
					Filters
				</span>
				<FaFilter
					size={20}
					className="text-lime-500 hover:text-purple-800"
				/>
			</div>
			<div className="w-full text-white">
				...
				<div className="grid h-screen xl:grid-cols-3 sm:grid-cols-2 grid-cols-1 text-white overflow-y-auto">
					{videos &&
